...
class _OperatorProfileScreenState extends State<OperatorProfileScreen> {
    ...
    try {
      ...
      setState(() {
        ...
        if (cityState.contains(',')) {
          ...
          _profileController.stateController.text = parts.sublist(1).join(',').trim();
        } else {
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      border: Border.all(color: cyberBlue, width: 2),
                                      boxShadow: [
                                        BoxShadow(
                                ...
                                Obx(() => Row(
                                      children: [
                                        _buildImagePickerBox(
                                          label: "Front Side",
                                          file: _profileController.frontImage.value,
                                        ...
                                        _buildImagePickerBox(
                                          label: "Back Side",
                                          file: _profileController.backImage.value,
                                          onTap: () => _showImageSourceDialog(false,
                                              isFront: false),
                                        ),
                                      ],
  ...
  Widget _buildImagePickerBox(
      {required String label, required File? file, required VoidCallback onTap}) {
    return Expanded(
